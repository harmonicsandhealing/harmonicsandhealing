        ...
        >
          ...
          <div style={{ padding: '80px 2rem 2rem', minHeight: '100vh' }}>
            <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', gap: '3rem', alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              {activeModal === 'healing' && (
                <>
                  <div style={{ flex: 1, minWidth: '300px', height: '400px', backgroundImage: `url(${healingBg})`, backgroundSize: 'cover', borderRadius: '10px' }}></div>
              ...
              {activeModal === 'gong' && (
                <>
                  ...
                  <div style={{ flex: 1, minWidth: '300px', height: '400px', backgroundImage: `url(${gongBg})`, backgroundSize: 'cover', borderRadius: '10px' }}></div>
                </>
              )}
              ...
              {activeModal === 'about' && (
                <>
                  <div style={{ flex: 1, minWidth: '300px', height: '400px', backgroundImage: `url(${aboutBg})`, backgroundSize: 'cover', borderRadius: '10px' }}></div>
                  <div style={{ flex: 1, minWidth: '300px', color: '#000' }}>
